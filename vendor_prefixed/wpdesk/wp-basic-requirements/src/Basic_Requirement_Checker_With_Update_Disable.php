...
if (!\class_exists('FPFProVendor\\WPDesk_Basic_Requirement_Checker')) {
...
if (!\class_exists('FPFProVendor\\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker_With_Update_Disable extends \FPFProVendor\WPDesk_Basic_Requirement_Checker
    {
        /**
