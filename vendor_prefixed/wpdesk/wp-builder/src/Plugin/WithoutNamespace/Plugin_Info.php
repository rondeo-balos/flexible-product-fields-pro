...
if (!\interface_exists('FPFProVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('FPFProVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('FPFProVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \FPFProVendor\WPDesk_Translatable, \FPFProVendor\WPDesk_Buildable, \FPFProVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
