...
namespace FPFProVendor\WPDesk\Helper\Logs;

use FPFProVendor\Monolog\Processor\ProcessorInterface;
 ...
 */
class LibraryInfoProcessor implements \FPFProVendor\Monolog\Processor\ProcessorInterface
{
    /** @var LibraryDebug */
    private $library_debug;
    public function __construct(\FPFProVendor\WPDesk\Helper\Debug\LibraryDebug $library_debug)
    {
