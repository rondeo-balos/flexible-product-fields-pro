...
use FPFProVendor\WPDesk\License\Page\LicensePage;
 ...
 */
class LicenseIntegration implements \FPFProVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \FPFProVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \FPFProVendor\WPDesk\License\Page\LicensePage($plugin_registry);
