...
namespace FPFProVendor\WPDesk\Notice;

use FPFProVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
 ...
 */
class AjaxHandler implements \FPFProVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant
{
    use PluginAccess;
    ...
    public function processAjaxNoticeDismiss()
    {
        if (isset($_POST[self::POST_FIELD_NOTICE_NAME])) {
            ...
            \update_option(\FPFProVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_NAME_PREFIX . $noticeName, \FPFProVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_VALUE_DISMISSED);
