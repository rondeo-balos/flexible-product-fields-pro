...
use FPFProVendor\WPDesk\License\ServerAddressRepository;
 ...
 */
class LicenseActivation implements \FPFProVendor\WPDesk\License\Page\Action
{
    /**
     * Plugin data.
     *
    ...
    public function execute(array $plugin)
    {
        ...
        $this->activate_license($activation_email, $api_key, new \FPFProVendor\WPDesk\License\ServerAddressRepository($product_id));
    }
    /**
     ...
     */
    public function activate_license($activation_email, $api_key, \FPFProVendor\WPDesk\License\ServerAddressRepository $address_repository)
    {
