 ...
 */
class CreateCodeceptionTests extends \FPFProVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \FPFProVendor\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**
