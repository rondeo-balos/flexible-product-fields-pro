 ...
 */
class BrowserConsoleHandler extends \FPFProVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \FPFProVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
