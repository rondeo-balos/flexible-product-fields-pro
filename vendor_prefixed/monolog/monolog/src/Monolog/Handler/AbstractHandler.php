 ...
 */
abstract class AbstractHandler implements \FPFProVendor\Monolog\Handler\HandlerInterface, \FPFProVendor\Monolog\ResettableInterface
{
    protected $level = \FPFProVendor\Monolog\Logger::DEBUG;
    ...
    {
        $this->level = \FPFProVendor\Monolog\Logger::toMonologLevel($level);
        return $this;
    }
    /**
    ...
    {
        return new \FPFProVendor\Monolog\Formatter\LineFormatter();
    }
}
