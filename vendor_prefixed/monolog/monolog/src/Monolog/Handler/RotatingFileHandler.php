 ...
 */
class RotatingFileHandler extends \FPFProVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \FPFProVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \FPFProVendor\Monolog\Utils::canonicalizePath($filename);
